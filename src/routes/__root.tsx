...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Trade with ACE — Discipline coach for day traders" },
      { name: "description", content: "Trade with ACE is a floating desktop coach for day traders. Pre-trade checklists, trade counter, risk guardrails, and AI mentor — free, Windows & Mac." },
      { property: "og:site_name", content: "Trade with ACE" },
      { property: "og:title", content: "Trade with ACE — Discipline coach for day traders" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Discipline coach desktop app for day traders.",
        }),
      },
    ],
  }),
