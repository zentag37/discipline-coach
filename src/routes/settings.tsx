          ...
          <main className="flex-1 p-7 max-w-[820px] space-y-10">
              ...
              {(() => {
                ...
                return (
                  <div className="p-5 rounded-[10px]"
                    ...
                    {confirmCancel && (
                      <div className="mt-4 p-4 rounded-[10px]" style={{ background: "rgba(0,212,160,0.08)", border: `1px solid ${RED}55` }}>
            ...
            <Section id="security" title="Security" refs={refs}>
              ...
              <div className="p-4 rounded-[10px]"
                style={{ background: "rgba(0,212,160,0.05)", border: `1px solid ${RED}30` }}>
